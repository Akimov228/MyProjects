...
class Minion(Hero):
    ...
    def apply_super_power(self, boss, heroes):
        ...
        """Новый герой - Минион, имеет сильный урон , но слабое здоровье .
        Обладает способность увеличенного урона по боссу,
        то есть урон умноженный на рандомный коэффициент"""
